...
var handleThemePanel = function () {
  ...
  if (elm) {
    elm.onclick = function (e) {
      ...
      var targetExpand = target.classList.contains(app.themePanel.activeClass)
        ? false
        : true;
  ...
  if (elms) {
    elms.map(function (elm) {
      elm.onclick = function () {
        var targetThemeClass = this.getAttribute(
  ...
  if (
    ...
    getCookie(app.themePanel.cookieName) == "true"
  ) {
...
var handleCssVariable = function () {
  ...
  if (app.variableFontList && app.variablePrefix) {
    for (var i = 0; i < app.variableFontList.length; i++) {
      app.font[
        app.variableFontList[i].replace(/-([a-z|0-9])/g, (match, letter) =>
          letter.toUpperCase()
        )
      ] = rootStyle
        .getPropertyValue("--" + app.variablePrefix + app.variableFontList[i])
        .trim();
    }
  }
  ...
  if (app.variableColorList && app.variablePrefix) {
    for (var i = 0; i < app.variableColorList.length; i++) {
      app.color[
        app.variableColorList[i].replace(/-([a-z|0-9])/g, (match, letter) =>
          letter.toUpperCase()
        )
      ] = rootStyle
        .getPropertyValue("--" + app.variablePrefix + app.variableColorList[i])
        .trim();
    }
  }
};
