        ...
        <Modal.Body>
          <div className="row mb-3">
            <div className="col-md-12">
              ...
              <Input className="form-label" value={customerData.cust_name} onChange={(value) => handleChange("cust_name", value)}
              placeholder="ຊື່..." required />
            </div>
            <div className="col-md-12">
              <label className="form-label">ນາມສະກຸນ</label>
              <Input className="form-label" value={customerData.cust_surname} onChange={(value) => handleChange("cust_surname", value)}
             placeholder="ນາມສະກຸນ..." required/>
            </div>
            <div className="col-md-12">
              <label className="form-label">ອີເມວ໌</label>
              <Input className="form-label" value={customerData.email} onChange={(value) => handleChange("email", value)}
                placeholder="ອີເມວ໌..."/>
            </div>
            </div>
        </Modal.Body>
