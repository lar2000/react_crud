        ...
        <Modal.Body>
          <div className="row mb-3">
            ...
            <div className="col-md-6">
              ...
              <Input className="form-label" value={staffData.staff_name} onChange={(value) => handleChange("staff_name", value)}
              placeholder="ຊື່..." required />
            </div>
            <div className="col-md-6">
              <label className="form-label">ນາມສະກຸນ</label>
              <Input className="form-label" value={staffData.staff_surname} onChange={(value) => handleChange("staff_surname", value)}
             placeholder="ນາມສະກຸນ..." required/>
            </div>
            <div className="col-md-12">
              <label className="form-label">ອີເມວ໌</label>
              <Input className="form-label" value={staffData.email} onChange={(value) => handleChange("email", value)}
                placeholder="ອີເມວ໌..."/>
            </div>
            <div className="col-md-6">
              <label className="form-label">ເບີໂທ</label>
              <Input className="form-label" value={staffData.tell} onChange={(value) => handleChange("tell", value.replace(/[^0-9]/g, ""))}
